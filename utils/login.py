...
def initializeTables():
    ...
    c.execute("CREATE TABLE IF NOT EXISTS inventory (userID INTEGER, item TEXT NOT NULL, health INTEGER, atk INTEGER, atkspeed INTEGER, speed INTEGER, def INTEGER, int INTEGER)")
